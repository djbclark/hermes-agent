...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("aiuse", "Show live AI subscription and API usage directly (no AI turn)", "Info",
               busy_policy="dispatch"),
...
#     Slack. Added at the 50-cap — a native slot would clamp an existing
#     native slash.
_SLACK_VIA_HERMES_ONLY = frozenset({"topup", "moa", "debug", "egress", "init", "version", "diff", "update", "heartbeat", "refine", "pause", "whoami", "platform", "aiuse", "clinepass"})

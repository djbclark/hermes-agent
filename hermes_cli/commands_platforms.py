...
_SLACK_VIA_HERMES_ONLY = frozenset({
    ...
    # Fork: aiuse (usage dump) and clinepass (level switcher) reached via /hermes <cmd> on
    # Slack — both added at the 50-cap, a native slot would clamp an existing native slash.
    "aiuse", "clinepass"})
